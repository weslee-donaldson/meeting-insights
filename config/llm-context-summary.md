...
| Dir | Summary | Scatter |
|-----|---------|---------|
| `prompts/` | LLM prompt templates for extraction, insight generation, deep search, and thread evaluation | [prompts/llm-context.md](prompts/llm-context.md) |
...
- Parent: [llm-context.md](llm-context.md)
