...
var require_lib2 = __commonJS({
  "node_modules/.pnpm/@babel+code-frame@7.28.6/node_modules/@babel/code-frame/lib/index.js"(exports2) {
    "use strict";
...
var require_loaders = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/loaders.js"(exports2) {
    "use strict";
...
// node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/defaults.js
var require_defaults = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/defaults.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
// node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/util.js
var require_util = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/util.js"(exports2) {
    "use strict";
    ...
    function removeUndefinedValuesFromObject(options2) {
...
// node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/ExplorerBase.js
var require_ExplorerBase = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/ExplorerBase.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
// node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/merge.js
var require_merge2 = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/merge.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
      ...
      for (const key of Object.keys(source)) {
        ...
        if ((0, exports2.hasOwn)(target, key)) {
          if (Array.isArray(target[key]) && Array.isArray(newValue)) {
            ...
            target[key] = merge(target[key], newValue, options2);
            continue;
          }
        }
        target[key] = newValue;
    ...
    function mergeAll(objects, options2) {
      return objects.reduce((target, source) => merge(target, source, options2), {});
    }
    exports2.mergeAll = mergeAll;
  }
});

// node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/Explorer.js
var require_Explorer = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/Explorer.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
// node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/ExplorerSync.js
var require_ExplorerSync = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/ExplorerSync.js"(exports2) {
    "use strict";
    var __importDefault = exports2 && exports2.__importDefault || function(mod) {
      return mod && mod.__esModule ? mod : { "default": mod };
    };
...
// node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/index.js
var require_dist = __commonJS({
  "node_modules/.pnpm/cosmiconfig@9.0.0_typescript@5.9.3/node_modules/cosmiconfig/dist/index.js"(exports2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
    ...
    function mergeOptionsBase(moduleName, defaults, options2) {
      const userDefinedConfig = getUserDefinedOptionsFromMetaConfig();
      if (!userDefinedConfig) {
        return {
          ...defaults,
          ...(0, util_1.removeUndefinedValuesFromObject)(options2),
          loaders: {
            ...defaults.loaders,
            ...options2.loaders
          }
      ...
      const toolDefinedSearchPlaces = options2.searchPlaces ?? defaults.searchPlaces;
      return {
        ...defaults,
        ...(0, util_1.removeUndefinedValuesFromObject)(options2),
    ...
    function validateOptions(options2) {
      if (options2.searchStrategy != null && options2.searchStrategy !== "global" && options2.stopDir) {
        throw new Error('Can not supply `stopDir` option with `searchStrategy` other than "global"');
      }
    }
    function mergeOptions(moduleName, options2) {
      ...
      const defaults = {
        ...
        mergeImportArrays: true,
        mergeSearchPlaces: true,
        searchStrategy: options2.stopDir ? "global" : "none"
      };
      return mergeOptionsBase(moduleName, defaults, options2);
    }
    function mergeOptionsSync(moduleName, options2) {
      validateOptions(options2);
      const defaults = {
        moduleName,
    ...
    function cosmiconfig2(moduleName, options2 = {}) {
      const normalizedOptions = mergeOptions(moduleName, options2);
    ...
    function cosmiconfigSync(moduleName, options2 = {}) {
      const normalizedOptions = mergeOptionsSync(moduleName, options2);
...
function debugLog(autoDir, hookName, message) {
  ...
  const logPath = import_node_path2.default.join(logsDir, "debug.log");
  const timestamp = (/* @__PURE__ */ new Date()).toISOString();
  const entry = `${timestamp} [${hookName}] ${message}
`;
  import_node_fs2.default.appendFileSync(logPath, entry);
}
...
// src/reminder-loader.ts
var fs4 = __toESM(require("node:fs"));
var path5 = __toESM(require("node:path"));
var import_gray_matter = __toESM(require_gray_matter());
function scanReminders(remindersDir) {
  if (!fs4.existsSync(remindersDir)) {
    return [];
  }
  return fs4.readdirSync(remindersDir).filter((f) => f.endsWith(".md"));
}
function parseReminder(content, filename) {
...
function matchReminders(reminders, context) {
...
function sortByPriority(reminders) {
  return [...reminders].sort((a, b) => b.priority - a.priority);
}
function loadReminders(remindersDir, context) {
  const filenames = scanReminders(remindersDir);
  const reminders = filenames.map((filename) => {
    const content = fs4.readFileSync(path5.join(remindersDir, filename), "utf8");
...
async function handleSessionStart(claudeDir2, sessionId = "", agentType) {
...
// scripts/session-start.ts
var input = parseHookInput(fs5.readFileSync(0, "utf-8"));
var claudeDir = resolveClaudeDirFromScript(__dirname);
var startTime = Date.now();
(async () => {
  const { autoDir } = await resolvePaths(claudeDir);
  try {
    const { diagnostics, ...result } = await handleSessionStart(claudeDir, input.session_id, input.agent_type);
