...
| Dir | Summary | Scatter |
|-----|---------|---------|
| `handlers/` | Domain handler modules (meetings, search, threads, insights, milestones, config) | [llm-context.md](handlers/llm-context.md) |
| `main/` | Electron main entry — window creation, IPC registration, app lifecycle | [llm-context.md](main/llm-context.md) |
| `preload/` | Context bridge script that exposes `window.api` to the renderer | [llm-context.md](preload/llm-context.md) |
