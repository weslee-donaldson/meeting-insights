...
| Dir | Summary | README |
|-----|---------|--------|
| `handlers/` | Domain handler modules (meetings, search, threads, insights, milestones, config) | [README](handlers/README.md) |
| `main/` | Electron main entry — window creation, IPC registration, app lifecycle | [README](main/README.md) |
| `preload/` | Context bridge script that exposes `window.api` to the renderer | [README](preload/README.md) |
