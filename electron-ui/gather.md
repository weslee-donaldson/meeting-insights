...
| Dir | Summary | Docs |
|-----|---------|------|
| `electron/` | Main process: IPC handlers, channel contract, app entry, preload bridge | [scatter](electron/scatter.md) · [gather](electron/gather.md) |
| `ui/` | React application: components, pages, hooks, API client | [gather](ui/gather.md) |
