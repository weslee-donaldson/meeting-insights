...
| File | Purpose |
|------|---------|
| `LinearShell.tsx` | Three-zone fixed layout (nav rail, left panel, right panel); accepts slot children and renders them in the appropriate zones |
...
| Dir | Summary | README |
|-----|---------|--------|
| `ui/` | Radix/shadcn primitives and Lexical rich-text editor | [README](ui/README.md) |
