...
| Dir | Summary | Scatter |
|-----|---------|---------|
| `shared/` | Cross-domain reusable patterns (command bar, filter bar, list rows, density toggle, show-more, chat FAB) | [scatter.md](shared/scatter.md) |
| `ui/` | Radix/shadcn primitives, Lexical rich-text editor, bottom-sheet, and responsive-dialog | [scatter.md](ui/scatter.md) |
...
- Scatter file: [scatter.md](scatter.md)
