...
| Dir | Summary | Scatter |
|-----|---------|---------|
| `components/` | Domain and layout UI components | [llm-context.md](components/llm-context.md) |
| `pages/` | Feature view composers rendered by App.tsx | [llm-context.md](pages/llm-context.md) |
| `hooks/` | Data query hooks and stateful feature hooks | [llm-context.md](hooks/llm-context.md) |
| `lib/` | Utility functions (cn, artifact merging) | [llm-context.md](lib/llm-context.md) |
| `api-client/` | HTTP fetch implementation of ElectronAPI for web mode | [llm-context.md](api-client/llm-context.md) |
...
- Scatter: [llm-context.md](llm-context.md)
