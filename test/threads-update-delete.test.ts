...
describe("updateThread", () => {
  it("updates title and updated_at, leaving other fields unchanged", () => {
    const thread = createThread(db, { client_name: "Acme", client_id: acmeClientId, title: "Old title", shorthand: "OT", description: "desc", criteria_prompt: "crit" });
  ...
  it("updates status to resolved", () => {
    const thread = createThread(db, { client_name: "Acme", client_id: acmeClientId, title: "My thread", shorthand: "MT", description: "", criteria_prompt: "" });
  ...
  it("updates criteria_prompt and sets criteria_changed_at to now", () => {
    const thread = createThread(db, { client_name: "Acme", client_id: acmeClientId, title: "My thread", shorthand: "MT", description: "", criteria_prompt: "old criteria" });
  ...
  it("does not change criteria_changed_at when criteria_prompt unchanged", () => {
    const thread = createThread(db, { client_name: "Acme", client_id: acmeClientId, title: "My thread", shorthand: "MT", description: "", criteria_prompt: "same" });
...
describe("deleteThread", () => {
  it("deletes the thread from the database", () => {
    const thread = createThread(db, { client_name: "Acme", client_id: acmeClientId, title: "To delete", shorthand: "TD", description: "", criteria_prompt: "" });
    deleteThread(db, thread.id);
    expect(getThread(db, thread.id)).toBeNull();
  });

  it("cascades delete to thread_meetings", () => {
    const thread = createThread(db, { client_name: "Acme", client_id: acmeClientId, title: "With meetings", shorthand: "WM", description: "", criteria_prompt: "" });
  ...
  it("cascades delete to thread_messages", () => {
    const thread = createThread(db, { client_name: "Acme", client_id: acmeClientId, title: "With messages", shorthand: "WMS", description: "", criteria_prompt: "" });
