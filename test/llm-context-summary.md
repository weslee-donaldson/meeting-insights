...
| Dir | Summary | Scatter |
|-----|---------|---------|
| `ui/` | React component and hook tests (jsdom + @testing-library/react) | [ui/llm-context.md](ui/llm-context.md) |
| `e2e/` | Playwright browser tests against live API + web servers | [e2e/llm-context.md](e2e/llm-context.md) |
