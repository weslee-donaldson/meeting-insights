...
describe("ScopeBar", () => {
  it("renders Reset button", () => {
    render(<ScopeBar {...defaultProps} />, { wrapper: makeWrapper() });
    expect(screen.getByRole("button", { name: /reset/i })).toBeDefined();
  });

  it("calls onReset when Reset is clicked", () => {
    const onReset = vi.fn();
    render(<ScopeBar {...defaultProps} onReset={onReset} />, { wrapper: makeWrapper() });
  ...
  it("calls onDateChange when after date changes", () => {
    ...
    render(<ScopeBar {...defaultProps} onDateChange={onDateChange} />, { wrapper: makeWrapper() });
  ...
  it("calls setTheme with next theme when cycle button is clicked", () => {
    ...
    render(<ScopeBar {...defaultProps} setTheme={setTheme} />, { wrapper: makeWrapper() });
