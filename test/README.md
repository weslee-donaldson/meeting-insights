...
| Dir | Summary | README |
|-----|---------|--------|
| `ui/` | React component and hook tests (jsdom + @testing-library/react) | [ui/README.md](ui/README.md) |
| `e2e/` | Playwright browser tests against live API + web servers | [e2e/README.md](e2e/README.md) |
