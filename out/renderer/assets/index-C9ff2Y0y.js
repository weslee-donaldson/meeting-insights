...
const Clipboard = createLucideIcon("clipboard", __iconNode$6);
const __iconNode$5 = [
  ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
  ["path", { d: "M9 3v18", key: "fh3hqa" }],
  ["path", { d: "m16 15-3-3 3-3", key: "14y99z" }]
];
const PanelLeftClose = createLucideIcon("panel-left-close", __iconNode$5);
const __iconNode$4 = [
  ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
  ["path", { d: "M9 3v18", key: "fh3hqa" }],
  ["path", { d: "m14 9 3 3-3 3", key: "8010ee" }]
];
const PanelLeftOpen = createLucideIcon("panel-left-open", __iconNode$4);
const __iconNode$3 = [
  ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
  ["path", { d: "M15 3v18", key: "14nvp0" }],
  ["path", { d: "m8 9 3 3-3 3", key: "12hl5m" }]
];
const PanelRightClose = createLucideIcon("panel-right-close", __iconNode$3);
const __iconNode$2 = [
  ["rect", { width: "18", height: "18", x: "3", y: "3", rx: "2", key: "afitv7" }],
  ["path", { d: "M15 3v18", key: "14nvp0" }],
  ["path", { d: "m10 15-3-3 3-3", key: "1pgupc" }]
];
const PanelRightOpen = createLucideIcon("panel-right-open", __iconNode$2);
const __iconNode$1 = [
...
function ScopeBar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 px-4 py-2 bg-zinc-900 border-b border-zinc-800 text-sm shrink-0", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500 font-medium", children: "Scope:" }),
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Trigger$1,
            {
              ...
              "aria-label": "Client",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Value, { placeholder: "All Clients" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3 text-zinc-400 ml-auto" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Portal, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Content2, { className: "bg-zinc-800 rounded shadow-xl border border-zinc-700 z-50", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Viewport, { className: "p-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Item,
              {
                value: "__all",
                className: "px-3 py-1.5 rounded cursor-pointer text-zinc-300 hover:bg-zinc-700 focus:outline-none",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(ItemText, { children: "All Clients" })
              }
            ),
            clients.map((c) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Item,
              {
                value: c,
                className: "px-3 py-1.5 rounded cursor-pointer text-zinc-100 hover:bg-zinc-700 focus:outline-none",
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(ItemText, { children: c })
              },
              c
            ))
          ] }) }) })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "From" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "date",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-500", children: "to" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "date",
...
let se;
function gt() {
  return se === void 0 && (typeof matchMedia == "function" ? se = !!matchMedia("(pointer:coarse)").matches : se = false), se;
}
function Ve(e) {
  ...
  let r = false, a = false, u = -1, c = -1, g = 0, b, S = [];
  {
    let m = -1;
    for (const d of s)
...
let ae;
function Ee() {
  return ae === void 0 && (ae = false, typeof window < "u" && (window.navigator.userAgent.includes("Chrome") || window.navigator.userAgent.includes("Firefox")) && (ae = true)), ae;
}
function Mt({
  cursorFlags: e,
  groups: t,
...
function Je({
  ...
  n.forEach((c) => {
    ...
    const h = o.get(g), {
      ...
      layout: y,
      separatorToPanels: p
    } = i.get(g) ?? { defaultLayoutDeferred: false };
    if (x && h && y && p) {
      const w = oe({
        delta: f,
        initialLayout: h,
...
function It(e) {
  ...
  }), q.get(S) === 1 && (S.addEventListener("dblclick", Le, true), S.addEventListener("pointerdown", Ce, true), S.addEventListener("pointerleave", Ge), S.addEventListener("pointermove", Ie), S.addEventListener("pointerout", De), S.addEventListener("pointerup", Oe, true)), function() {
    t = false, q.set(
      S,
      ...
      Ce,
      true
    ), S.removeEventListener("pointerleave", Ge), S.removeEventListener("pointermove", Ie), S.removeEventListener("pointerout", De), S.removeEventListener("pointerup", Oe, true)), s.disconnect();
  };
}
function Dt() {
...
function Tt({
  ...
  }), h = ye(r), v = reactExports.useRef(null), [x, y] = Dt(), p = reactExports.useRef({
  ...
  }), /* @__PURE__ */ jsxRuntimeExports.jsx(Ze.Provider, { value: X, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...S,
      className: t,
...
function Nt(e, t) {
  const { id: n } = xe(), o = reactExports.useRef({
    collapse: fe,
    expand: fe,
    getSize: () => ({
      asPercentage: 0,
...
function _t({
  ...
  const m = !!r, d = ye(r), f = ve({
    disabled: s
  }), h = reactExports.useRef(null), v = Se(h, l), {
    getPanelStyles: x,
    id: y,
    orientation: p,
    registerPanel: w,
  ...
  const V = reactExports.useSyncExternalStore(
...
function Ht({
  ...
  const r = ye(i), a = ve({
    disabled: n
  }), [u, c] = reactExports.useState({}), [g, b] = reactExports.useState("inactive"), S = reactExports.useRef(null), m = Se(S, o), {
    disableCursor: d,
    id: f,
    orientation: h,
    registerSeparator: v,
  ...
  }, [f, r, v, a]), reactExports.useEffect(() => {
    x(r, !!n);
  }, [n, r, x]);
  let p;
  return n && !d && (p = "not-allowed"), /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...l,
...
function AppLayout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tt, { orientation: "horizontal", className: "flex-1 overflow-hidden", style: { display: "flex" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      _t,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-xs font-semibold text-zinc-500 uppercase tracking-wider border-b border-zinc-800", children: "Clients" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: clientsPanel })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ht, { style: { width: 1, background: "#27272a", cursor: "col-resize" } }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      _t,
      {
        ...
        style: { display: "flex", flexDirection: "column", overflow: "hidden", borderRight: "1px solid #27272a" },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 text-xs font-semibold text-zinc-500 uppercase tracking-wider border-b border-zinc-800", children: "Meetings" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: meetingsPanel })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ht, { style: { width: 1, background: "#27272a", cursor: "col-resize" } }),
    !contextCollapsed ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        _t,
        {
          ...
          style: { display: "flex", flexDirection: "column", overflow: "hidden", borderRight: "1px solid #27272a" },
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center px-3 py-2 border-b border-zinc-800", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-zinc-500 uppercase tracking-wider flex-1", children: "Context" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelRightClose, { className: "w-4 h-4" })
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-y-auto", children: contextPanel })
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Ht, { style: { width: 1, background: "#27272a", cursor: "col-resize" } })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", borderRight: "1px solid #27272a", background: "#18181b" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: onCollapseContext,
    ...
    !chatCollapsed ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      _t,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center px-3 py-2 border-b border-zinc-800", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-zinc-500 uppercase tracking-wider flex-1", children: "Chat" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 overflow-hidden", children: chatPanel })
        ]
      }
    ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", background: "#18181b" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: onCollapseChat,
        className: "p-2 text-zinc-500 hover:text-zinc-300",
        "aria-label": "Expand chat panel",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelRightOpen, { className: "w-4 h-4" })
      }
    ) })
  ] }) });
}
function ClientsColumn({ clients, selected, onSelect }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "py-1", children: clients.map((name) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      onClick: () => onSelect(name),
      "aria-selected": selected === name,
      className: `w-full text-left px-3 py-2 text-sm flex items-center gap-2 transition-colors ${selected === name ? "bg-zinc-800 text-zinc-100" : "text-zinc-400 hover:bg-zinc-900 hover:text-zinc-100"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Circle,
          {
...
function groupBySeries(meetings) {
...
function MeetingsColumn({ meetings, selected, onToggle, onToggleGroup }) {
  const groups = reactExports.useMemo(() => groupBySeries(meetings), [meetings]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "py-1", children: [
    groups.map((group) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center px-3 py-1.5 mt-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-zinc-500 uppercase tracking-wider flex-1 truncate", children: group.label }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        group.meetings.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "label",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-zinc-300 truncate", children: m.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-zinc-600", children: [
                  m.date.slice(0, 10),
                  m.client && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-1 text-zinc-700", children: [
                    "[",
                    m.client,
                    "]"
                  ] })
    ...
    meetings.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-4 text-xs text-zinc-600", children: "No meetings in scope" })
  ] });
}
...
function Section({ title, children, isEmpty }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Root, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Trigger, { className: "flex items-center gap-1 w-full text-left py-1 text-xs font-semibold text-zinc-500 hover:text-zinc-300 uppercase tracking-wider", children: [
      open ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-3 h-3 shrink-0" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "w-3 h-3 shrink-0" }),
      title
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Content, { className: "mt-1 text-sm text-zinc-300 space-y-1", children })
  ] });
}
function ArtifactView({ artifact }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Summary", isEmpty: !artifact.summary, children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-zinc-400 leading-relaxed", children: artifact.summary }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Decisions", isEmpty: !hasDecisions, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: artifact.decisions.map((d, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-600 shrink-0", children: "—" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: d })
    ] }, i)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Action Items", isEmpty: !hasActionItems, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: artifact.action_items.map((a, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-600 shrink-0", children: "□" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
        a.description,
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-zinc-500 ml-1", children: [
          "(",
          a.owner,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Open Questions", isEmpty: !hasQuestions, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: artifact.open_questions.map((q2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-600 shrink-0", children: "?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: q2 })
    ] }, i)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Risks", isEmpty: !hasRisks, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: artifact.risk_items.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-600 shrink-0", children: "⚠" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: r })
    ] }, i)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Proposed Features", isEmpty: !hasFeatures, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: artifact.proposed_features.map((f, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-600 shrink-0", children: "✦" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: f })
    ] }, i)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Technical Topics", isEmpty: !hasTopics, children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-0.5", children: artifact.technical_topics.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-600 shrink-0", children: "◆" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: t })
    ] }, i)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { title: "Additional Notes", isEmpty: !hasNotes, children: artifact.additional_notes.map((note, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-0.5", children: [
        header && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-zinc-400 font-medium", children: String(header[1]) }),
        entries.filter(([k2]) => k2 !== header?.[0]).map(([k2, v]) => {
          const items = Array.isArray(v) ? v : typeof v === "string" ? [v] : [];
          return items.map((item, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 pl-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-zinc-600", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: String(item) })
          ] }, `${k2}-${j}`));
        })
      ] }, i);
    }) })
...
function ContextViewColumn({ meetings }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "divide-y divide-zinc-800", children: [
    meetings.map(({ meeting, artifact }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-zinc-100 text-sm", children: meeting.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-zinc-500 mt-0.5", children: [
          meeting.date.slice(0, 10),
          meeting.client && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-zinc-600", children: [
            "[",
            meeting.client,
            "]"
          ] })
      ...
      artifact ? /* @__PURE__ */ jsxRuntimeExports.jsx(ArtifactView, { artifact }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-zinc-600", children: "No artifact extracted" })
    ] }, meeting.id)),
    meetings.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 text-xs text-zinc-600", children: "No meetings selected" })
  ] });
}
function ChatColumn({ contextInfo, onChat }) {
  ...
  const submit = reactExports.useCallback(async () => {
    ...
    setLoading(true);
    try {
      const response = await onChat(q2);
      setHistory((prev) => [
        ...prev,
        { question: q2, answer: response.answer, sources: response.sources }
      ]);
    } finally {
      setLoading(false);
  ...
  const copyToClipboard = reactExports.useCallback((text) => {
    navigator.clipboard.writeText(text).catch(() => {
    });
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-2 text-xs text-zinc-500 border-b border-zinc-800 shrink-0", children: [
      "Context:",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-zinc-400", children: [
        contextInfo.meetingCount,
        " meetings"
      ] }),
      " | ",
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-zinc-400", children: [
        contextInfo.charCount.toLocaleString(),
        " characters"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 overflow-y-auto px-4 py-4 space-y-6", children: [
      history.map((pair, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-zinc-500 font-medium", children: [
          "Q: ",
          pair.question
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-zinc-200 leading-relaxed whitespace-pre-wrap", children: pair.answer }),
        pair.sources.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-xs text-zinc-500", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Sources:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-0.5 space-y-0.5", children: pair.sources.map((s, j) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "pl-2", children: [
            "— ",
            s
          ] }, j)) })
        ] }),
...
A: ${pair.answer}`),
      ...
      loading && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-zinc-500 animate-pulse", children: "Thinking…" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: bottomRef })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-zinc-800 p-4 shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "textarea",
        {
          value: question,
...
function App() {
  ...
  const [dateRange, setDateRange] = reactExports.useState({ after: "", before: "" });
  const [selectedMeetingIds, setSelectedMeetingIds] = reactExports.useState(/* @__PURE__ */ new Set());
  const [contextCollapsed, setContextCollapsed] = reactExports.useState(false);
  const [chatCollapsed, setChatCollapsed] = reactExports.useState(false);
  ...
  const meetingsQuery = useQuery({
    ...
    queryFn: () => window.api.getMeetings({
      client: selectedClient ?? void 0,
      after: dateRange.after || void 0,
      before: dateRange.before || void 0
    })
  });
  const scopeMeetings = meetingsQuery.data ?? [];
  const activeMeetingIds = selectedMeetingIds.size > 0 ? [...selectedMeetingIds] : scopeMeetings.map((m) => m.id);
  const artifactsQuery = useQuery({
    queryKey: ["artifacts", activeMeetingIds],
    queryFn: async () => {
      const entries = await Promise.all(
        activeMeetingIds.map(async (id) => [id, await window.api.getArtifact(id)])
      );
      return Object.fromEntries(entries);
    },
    enabled: activeMeetingIds.length > 0
  });
  const activeMeetingsWithArtifacts = activeMeetingIds.map((id) => {
  ...
  const handleClientChange = reactExports.useCallback((name) => {
    setSelectedClient(name);
    setSelectedMeetingIds(/* @__PURE__ */ new Set());
  }, []);
  const handleDateChange = reactExports.useCallback((range) => {
    setDateRange(range);
  ...
  const handleToggle = reactExports.useCallback((id) => {
    setSelectedMeetingIds((prev) => {
  ...
  const handleToggleGroup = reactExports.useCallback((ids) => {
    setSelectedMeetingIds((prev) => {
  ...
  const handleChat = reactExports.useCallback(
    async (question) => {
      return window.api.chat({ meetingIds: activeMeetingIds, question });
    },
    [activeMeetingIds]
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-screen bg-zinc-950 text-zinc-100", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ScopeBar,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      AppLayout,
      {
        ...
        clientsPanel: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ClientsColumn,
          {
            clients: clientsQuery.data ?? [],
        ...
        meetingsPanel: /* @__PURE__ */ jsxRuntimeExports.jsx(
          MeetingsColumn,
          {
        ...
        contextPanel: /* @__PURE__ */ jsxRuntimeExports.jsx(ContextViewColumn, { meetings: activeMeetingsWithArtifacts }),
        chatPanel: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChatColumn,
          {
